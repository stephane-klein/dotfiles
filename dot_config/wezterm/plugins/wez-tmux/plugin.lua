-- My fork of https://github.com/sei40kr/wez-tmux/blob/main/plugin/init.lua
local M = {}
...
function M.apply_to_config(config, _)
  ...
  for i = index_offset, 9 do
    table.insert(keys, { key = tostring(i), mods = "LEADER|SHIFT", action = act.ActivateTab(i - index_offset) })
  end
